const Card = () => {
    return (
        ...
        <div className='flex space-x-2 h-screen bg-primary items-center'>
            <div className="w-60 h-82 border border-gray-200 rounded-2xl shadow bg-secondary dark:border-gray-700 ml-10">
